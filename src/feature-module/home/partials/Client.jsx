            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-gray-600 mt-6 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
                        {t('clientsSection.subtitle', 'Businesses of all sizes trust iGenia to provide innovative digital solutions.')}
                    </p>
                </motion.div>

                {/* Client Logo Grid with improved hover effects */}
                <AnimatePresence>
                    {isLoaded && (
                        <motion.div
                        ...
                        >                            {clients.map((client) => (
                            <motion.div
                                ...
                                onHoverStart={() => setHovered(client.id)}
                                onHoverEnd={() => setHovered(null)}
                            >                                    <div className="h-24 flex items-center justify-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 relative overflow-hidden">
                                    ...
                                    <motion.img
                                        src={client.logo}
                                        alt={client.name}
                                        className="max-h-16 w-auto object-contain relative z-10 filter grayscale hover:grayscale-0 transition-all duration-300"
                ...
                >                    <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                >
                        {t('clientsSection.joinButton', 'Become Our Client')}
